 ...
 *
 * Two courses, two meanings, and they are not interchangeable.
 *
 * A photographed course has a source: the passage says something the page also
 ...
 *
 * A written course has no source. `confidence` would be 1.0 for every passage
 ...
 * passage, they have not. Marking such a course "tout est relu" the second it
 * arrives is the one thing this must not do.
 *
 * Kept in one place because it was written out four times — twice in the course
