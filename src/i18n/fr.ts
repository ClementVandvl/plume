...
export const fr = {
  ...
  "adapt.intro":
    "Surlignez les mots à masquer : ils seront remplacés par un blanc de la même largeur dans la version aménagée, et imprimés normalement dans toutes les autres. Glissez sur plusieurs mots pour n'ouvrir qu'un seul trou ; repassez dessus pour annuler.",
  "adapt.nothing":
    "Ce document n'a pas encore de passage à adapter. Les titres et les schémas ne se surlignent pas.",
  "adapt.count.zero": "aucun trou",
  "adapt.count.one": "trou",
  "adapt.count.other": "trous",
  "adapt.clear": "Tout effacer",
  "export.pap.title": "Aménagement (PAP)",
  "export.pap.label": "Version à trous",
  "export.pap.on.one": "Un trou : le mot surligné laisse sa place blanche.",
  "export.pap.on.other": "{count} trous : les mots surlignés laissent leur place blanche.",
  "export.pap.off": "Le document complet, mots surlignés imprimés.",
